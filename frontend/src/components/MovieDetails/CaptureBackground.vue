<template>
    ...
    <ModalConfirmacion 
        ...
        @delete="deleteMovie" 
        :mensaje="'¿Esta seguro de querer eliminar esta pelicula?'"
    ></ModalConfirmacion>
    <ModalNewPelicula v-if="showEditMovie" @close="showEditMovie = false" :action="'edit'" :toEdit="movieData"></ModalNewPelicula>
</template>
