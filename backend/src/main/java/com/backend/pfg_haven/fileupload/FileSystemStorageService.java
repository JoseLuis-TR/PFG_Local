...
public class FileSystemStorageService implements StorageService {
    ...
    public String store(MultipartFile file) {
        ...
        try{
            if(file.isEmpty()){
                throw new StorageException("Sucedio un error con la subida de archivo");
            }
            ...
            throw new StorageException("Error al guardar el archivo " + filename);
        }
    }
    ...
    public Stream<Path> loadAll() {
        try {
            ...
            throw new StorageException("Error de lectura de archivos almacenados");
        }
